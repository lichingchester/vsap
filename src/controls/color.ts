/**
 * Minimal HSV ⇄ hex helpers for the kit color picker. The picker keeps HSV as
 * its internal model (so the saturation/value canvas + hue strip stay stable)
 * and only converts to/from hex at the edges.
 */
